...
public enum Gamemode {
	...
	public static List<Gamemode> getMCTiersGamemodes() {
		return Arrays.asList(Gamemode.values()).stream()
    	.filter(gamemode -> !List.of(Gamemode.DIAMOND_SMP, Gamemode.CART).contains(gamemode))
    	.toList();
	}
}
