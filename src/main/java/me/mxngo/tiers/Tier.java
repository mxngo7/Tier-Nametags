...
public enum Tier {
	...
	R((byte) (0b1 << 6), 0xFFFFFFFF, 0xFFFFFFFF),
	RHT1((byte) (R.value | HT.value | 0b001), 0xFF95EEF5, 0xFF7BDBE3, "textures/font/tiers/rht1.png"),
	RLT1((byte) (R.value | LT.value | 0b001), 0xFF95EEF5, 0xFF7BDBE3, "textures/font/tiers/rlt1.png"),
	RHT2((byte) (R.value | HT.value | 0b010), 0xFF87E096, 0xFF6BDB7E, "textures/font/tiers/rht2.png"),
	RLT2((byte) (R.value | LT.value | 0b010), 0xFF87E096, 0xFF6BDB7E, "textures/font/tiers/rlt2.png");
	...
	public boolean isRetired() {
		return ((this.value & Tier.R.value) > 0);
	}
	...
	public byte getTierValue() {
		...
		if (this.isRetired()) value -= Tier.R.getValue() - 1;
		return (byte) ((byte) ((5 - (value - (this.isHighTier() ? Tier.HT.getValue() : Tier.LT.getValue()))) * 2 + 1) - (this.isLowTier() ? 1 : 0));
	}
	
	public boolean isHigherThan(Tier other) {
		if (this.getTierValue() == other.getTierValue()) {
			if (this.isRetired()) return false;
			else if (other.isRetired()) return true;
		}
	...
	public boolean isLowerThan(Tier other) {
		if (this.getTierValue() == other.getTierValue()) {
			if (this.isRetired()) return true;
			else if (other.isRetired()) return false;
		}
